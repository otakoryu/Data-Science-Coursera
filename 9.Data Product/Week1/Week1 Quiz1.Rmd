...
Which of the following are absolutely necessary for creating a functioning shiny app?
...
_Ans_
  ...
  - The server.R output name is not the same as the plotOutput command used in ui.R.
  
---

###Q4
 
What are the main difference between creating a Shiny Gadget and creating a regular Shiny App?

_Ans_

  - Shiny Gadget are designed to be used by R users in the middle of a data analysis.
