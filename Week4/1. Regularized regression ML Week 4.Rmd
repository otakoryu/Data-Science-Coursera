---
title: "1. Regularized regression ML Week 4"
...
Even though, in the training set shows the decresing error rate as model inculdes more variables, in the test set , it wouldn't happen, simple due to over fitting 
...
If the $\beta_j$'s are unconstrained:  ; we don't make any particular claim that $\beta$ has be any specific value
...
What we want to here is that in oder to minimize the funtion of $PRSS$, we are seeking to the value of parameter $\beta$, otherwise, $PRSS$ will explosively become larger
